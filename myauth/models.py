...
class MyauthBookInfo(models.Model):
    book_name = models.CharField(max_length=50, blank=True, null=True)
    book_img = models.CharField(max_length=100, blank=True, null=True)
    ...
    book_starring = models.CharField(db_column='book_Starring', max_length=100, blank=True, null=True)  # Field name made lowercase.
    book_type = models.CharField(max_length=50, blank=True, null=True)
    book_point = models.FloatField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'myauth_book_info'


class MyauthCommuser(models.Model):
...
class MyauthUserEvaluation(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('id', 'user_id', 'book_id'), ('user_id', 'book_id'),)
